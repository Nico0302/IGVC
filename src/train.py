...
if __name__ == "__main__":
    ...
    originalMaskPaths = sorted(list(paths.list_images(config.MASK_DATASET_PATH)))
    maskPaths = []
    # dublicate masks by the number of variations
    for i in range(config.IMAGE_DATASET_VARIATION_COUNT):
        maskPaths += originalMaskPaths
